...
const memo: Buffer = Buffer.from(
  "Import CFLT to the P-Chain from the C-Chain and consume a multisig atomic output and a create multisig output"
)
...
const main = async (): Promise<any> => {
  ...
  utxos.forEach((utxo: UTXO): void => {
    ...
    if (cfltAssetID.toString("hex") === assetID.toString("hex")) {
