...
import { GetUTXOsResponse } from "coinflect/dist/apis/platformvm/interfaces"
import {
  PrivateKeyPrefix,
...
const memo: Buffer = Buffer.from(
  "PlatformVM utility method buildCreateSubnetTx to create a CreateSubnetTx which creates a 1-of-2 CFLT utxo and a 2-of-3 SubnetAuth"
)
