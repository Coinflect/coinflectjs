...
import { EVMAPI, KeyChain as EVMKeyChain } from "coinflect/dist/apis/evm"
import {
  PlatformVMAPI,
  KeyChain,
  SECPTransferOutput,
...
const fee: BN = MILLICFLT
const threshold: number = 2
const locktime: BN = new BN(0)
const memo: Buffer = Buffer.from(
  "Export CFLT from P-Chain to C-Chain and consume a multisig output and create a multisig atomic output"
)
