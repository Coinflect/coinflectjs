...
import {
  ...
  SECPTransferOutput,
  TransferableOutput
} from "coinflect/dist/apis/evm"
import { RequestResponseData } from "coinflect/dist/common"
import {
  PrivateKeyPrefix,
...
const main = async (): Promise<any> => {
  ...
  let cfltBalance: BN = await web3.eth.getBalance(cHexAddress)
  cfltBalance = new BN(cfltBalance.toString().substring(0, 17))
