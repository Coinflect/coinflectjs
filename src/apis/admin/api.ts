 ...
 * Instead, use the [[Coinflect.addAPI]] function to register this interface with Coinflect.
 */
...
export class AdminAPI extends JRPCAPI {
  ...
  /**
   * This class should not be instantiated directly. Instead use the [[Coinflect.addAPI]]
   * method.
   *
   * @param core A reference to the Coinflect class
   * @param baseURL Defaults to the string "/ext/admin" as the path to rpc's baseURL
   */
  constructor(core: CoinflectCore, baseURL: string = "/ext/admin") {
    super(core, baseURL)
  }
}
