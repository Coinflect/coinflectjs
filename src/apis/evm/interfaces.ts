...
export interface ExportCFLTParams extends CredsInterface {
  to: string
  amount: string
}

export interface ExportParams extends ExportCFLTParams {
  assetID: string
}
...
export interface ImportCFLTParams extends CredsInterface {
  to: string
  sourceChain: string
}

export interface ImportParams extends ImportCFLTParams {}
