...
export abstract class WeightedValidatorTx extends ValidatorTx {
   ...
   * @param endTime Optional. The Unix time when the validator stops validating the Primary Network (and staked CFLT is returned).
   * @param weight Optional. The amount of nCFLT the validator is staking.
   */
  constructor(
...
export class AddDelegatorTx extends WeightedValidatorTx {
   ...
   * @param startTime Optional. The Unix time when the validator starts validating the Primary Network.
   * @param endTime Optional. The Unix time when the validator stops validating the Primary Network (and staked CFLT is returned).
   * @param stakeAmount Optional. The amount of nCFLT the validator is staking.
