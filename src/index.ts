 ...
 * Example usage:
 * ```js
 * const coinflect: Coinflect = new Coinflect("127.0.0.1", 9650, "https")
 * ```
 *
 */
export default class Coinflect extends CoinflectCore {
  /**
  ...
  constructor(
    ...
    if (!skipinit) {
      ...
      this.addAPI("cchain", EVMAPI, "/ext/bc/C/cflt", cchainid)
