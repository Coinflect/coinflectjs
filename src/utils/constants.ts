...
export const PrimaryAssetAlias: string = "CFLT"
export const MainnetAPI: string = "api.coinflect.com"
export const AddismyaAPI: string = "api-test.coinflect.com"
...
// DO NOT use the following private keys and/or mnemonic on Addismya or Testnet
...
export const ONECFLT: BN = new BN(1000000000)

export const DECICFLT: BN = ONECFLT.div(new BN(10))

export const CENTICFLT: BN = ONECFLT.div(new BN(100))

export const MILLICFLT: BN = ONECFLT.div(new BN(1000))

export const MICROCFLT: BN = ONECFLT.div(new BN(1000000))

export const NANOCFLT: BN = ONECFLT.div(new BN(1000000000))

export const WEI: BN = new BN(1)

export const GWEI: BN = WEI.mul(new BN(1000000000))

export const CFLTGWEI: BN = NANOCFLT.clone()

export const CFLTSTAKECAP: BN = ONECFLT.mul(new BN(3000000))
...
const n0P: P = {
  ...
  fee: MILLICFLT,
  creationTxFee: CENTICFLT,
  createSubnetTx: ONECFLT,
  createChainTx: ONECFLT,
  minConsumption: 0.1,
  maxConsumption: 0.12,
  maxStakingDuration: new BN(31536000),
  maxSupply: new BN(720000000).mul(ONECFLT),
  minStake: ONECFLT.mul(new BN(2000)),
  minStakeDuration: 2 * 7 * 24 * 60 * 60, //two weeks
  maxStakeDuration: 365 * 24 * 60 * 60, // one year
  minDelegationStake: ONECFLT.mul(new BN(25)),
...
// Start mainnet
let cfltAssetID: string = "FvwEAhmxKfeiG8SnEvq42hc6whRyY3EFYAvebMqDNDGCgxN5Z"
const n1X: X = {
...
// Start Addismya
cfltAssetID = "U8iRqJoiJm8xZHAacmvYyZVwqQx6uDNtQeP3CQ6fcgQk3JqnK"
const n5X: X = {
