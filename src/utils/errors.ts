...
export class CoinflectError extends Error {
  errorCode: string
  constructor(m: string, code: string) {
    super(m)
    Object.setPrototypeOf(this, CoinflectError.prototype)
    this.errorCode = code
  }
...
export class AddressError extends CoinflectError {
...
export class GooseEggCheckError extends CoinflectError {
  constructor(m: string) {
...
export class ChainIdError extends CoinflectError {
  constructor(m: string) {
...
export class NoAtomicUTXOsError extends CoinflectError {
  constructor(m: string) {
...
export class SymbolError extends CoinflectError {
  constructor(m: string) {
...
export class NameError extends CoinflectError {
  constructor(m: string) {
...
export class TransactionError extends CoinflectError {
  constructor(m: string) {
...
export class CodecIdError extends CoinflectError {
  constructor(m: string) {
...
export class CredIdError extends CoinflectError {
  constructor(m: string) {
...
export class TransferableOutputError extends CoinflectError {
  constructor(m: string) {
...
export class TransferableInputError extends CoinflectError {
  constructor(m: string) {
...
export class InputIdError extends CoinflectError {
  constructor(m: string) {
...
export class OperationError extends CoinflectError {
  constructor(m: string) {
...
export class InvalidOperationIdError extends CoinflectError {
  constructor(m: string) {
...
export class ChecksumError extends CoinflectError {
  constructor(m: string) {
...
export class OutputIdError extends CoinflectError {
  constructor(m: string) {
...
export class UTXOError extends CoinflectError {
  constructor(m: string) {
...
export class InsufficientFundsError extends CoinflectError {
  constructor(m: string) {
...
export class ThresholdError extends CoinflectError {
  constructor(m: string) {
...
export class SECPMintOutputError extends CoinflectError {
  constructor(m: string) {
...
export class EVMInputError extends CoinflectError {
  constructor(m: string) {
...
export class EVMOutputError extends CoinflectError {
  constructor(m: string) {
...
export class FeeAssetError extends CoinflectError {
  constructor(m: string) {
...
export class StakeError extends CoinflectError {
  constructor(m: string) {
...
export class TimeError extends CoinflectError {
  constructor(m: string) {
...
export class DelegationFeeError extends CoinflectError {
  constructor(m: string) {
...
export class SubnetOwnerError extends CoinflectError {
  constructor(m: string) {
...
export class BufferSizeError extends CoinflectError {
  constructor(m: string) {
...
export class AddressIndexError extends CoinflectError {
  constructor(m: string) {
...
export class PublicKeyError extends CoinflectError {
  constructor(m: string) {
...
export class MergeRuleError extends CoinflectError {
  constructor(m: string) {
...
export class Base58Error extends CoinflectError {
  constructor(m: string) {
...
export class PrivateKeyError extends CoinflectError {
  constructor(m: string) {
...
export class NodeIdError extends CoinflectError {
  constructor(m: string) {
...
export class HexError extends CoinflectError {
  constructor(m: string) {
...
export class TypeIdError extends CoinflectError {
  constructor(m: string) {
...
export class TypeNameError extends CoinflectError {
  constructor(m: string) {
...
export class UnknownTypeError extends CoinflectError {
  constructor(m: string) {
...
export class Bech32Error extends CoinflectError {
  constructor(m: string) {
...
export class EVMFeeError extends CoinflectError {
  constructor(m: string) {
...
export class InvalidEntropy extends CoinflectError {
  constructor(m: string) {
...
export class ProtocolError extends CoinflectError {
  constructor(m: string) {
...
export class SubnetIdError extends CoinflectError {
  constructor(m: string) {
...
export class SubnetThresholdError extends CoinflectError {
  constructor(m: string) {
...
export class SubnetAddressError extends CoinflectError {
  constructor(m: string) {
