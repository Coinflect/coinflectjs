import Coinflect, { HDNode, Mnemonic } from "src"
...
describe("HDNode", (): void => {
  ...
  const addrs: string[] = [
    "X-cflt15qwuklmrfcmfw78yvka9pjsukjeevl4aveehq0",
    "X-cflt13wqaxm6zgjq5qwzuyyxyl9yrz3edcgwgfht6gt",
    "X-cflt1z3dn3vczxttts8dsdjfgtnkekf8nvqhhsj5stl",
    "X-cflt1j6kze9n7r3e8wq6jta5mf6pd3fwnu0v9wygc8p",
    "X-cflt1ngasfmvl8g63lzwznp0374myz7ajt4746g750m",
    "X-cflt1pr7pzcggtrk6uap58sfsrlnhqhayly2gtlux9l",
    "X-cflt1wwtn3gx7ke4ge2c29eg5sun36nyj55u4dle9gn",
    "X-cflt13527pvlnxa4wrfgt0h8ya7nkjawqq29sv5s89x",
    "X-cflt1gw6agtcsz969ugpqh2zx2lmjchg6npklvp43qq",
    "X-cflt10agjetvj0a0vf6wtlh7s6ctr8ha8ch8km8z567"
  ]
