...
describe("Serialization", (): void => {
  const address: string = "X-cflt1wst8jt3z3fm9ce0z6akj3266zmgccdp03hjlaj"
  ...
  const utf8: string = "from snowflake to Coinflect"
  ...
  describe("serialize && deserialize", (): void => {
    ...
    const xAddress: string = "X-cflt1pdurs53v6vtue9sw7am9ayjqh9mcnqe9s80sgn"
    ...
    const assetidHex: string =
      "9d0775f450604bd2fbc49ce0c5c1c6dfeb2dc2acb8c92c26eeae6e6df4502b19"
    const payload: Buffer = Buffer.from("From snowflake to Coinflect")
