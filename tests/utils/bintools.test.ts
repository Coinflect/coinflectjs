...
describe("BinTools", (): void => {
  ...
  test("stringToAddress", (): void => {
    // Missing prefix
    let addr: string = "-cflt13a4ye34zdfa33zeg3udnz533d6msfuqkds9hq7"
    expect((): void => {
      bintools.stringToAddress(addr)
    }).toThrow("Error - Valid address must have prefix before -")

    // Missing -
    addr = "Xcflt13a4ye34zdfa33zeg3udnz533d6msfuqkds9hq7"
    expect((): void => {
      bintools.stringToAddress(addr)
    }).toThrow("Error - Valid address should include -")

    // Missing seperator (1)
    addr = "X-cflt3a4ye34zdfa33zeg3udnz533d6msfuqkds9hq7"
    expect((): void => {
      bintools.stringToAddress(addr)
    ...
    // Invalid HRP
    addr = "X-cflt11ycxp65vz60m87mkm2hsw3m5fadjlpldzntvr33"
    expect((): void => {
      bintools.stringToAddress(addr)
    ...
    addrs = [
      "X-addismya1dcfyuug87xqayl4fpp02z9dvknwhafds7d29h6",
      "X-addismya1ltghj033re64920k786uprcp82p9e36jtkmpm3",
      "X-addismya1dq4q9seql2spxrkd7rl82uck5ej3nvlhk79w6t"
    ]
    addrs.forEach((address: string): void => {
      bintools.stringToAddress(address)
    })
    addrs = [
      "X-cflt1dcfyuug87xqayl4fpp02z9dvknwhafdsjlw6m9",
      "X-cflt1ltghj033re64920k786uprcp82p9e36j8yl7hw",
      "X-cflt1dq4q9seql2spxrkd7rl82uck5ej3nvlh6vp3k5"
    ]
    addrs.forEach((address: string): void => {
      bintools.stringToAddress(address)
    })
    ...
    addrs = [
      "P-addismya1dcfyuug87xqayl4fpp02z9dvknwhafds7d29h6",
      "P-addismya1ltghj033re64920k786uprcp82p9e36jtkmpm3",
      "P-addismya1dq4q9seql2spxrkd7rl82uck5ej3nvlhk79w6t"
    ]
    addrs.forEach((address: string): void => {
      bintools.stringToAddress(address)
    })
    addrs = [
      "P-cflt1dcfyuug87xqayl4fpp02z9dvknwhafdsjlw6m9",
      "P-cflt1ltghj033re64920k786uprcp82p9e36j8yl7hw",
      "P-cflt1dq4q9seql2spxrkd7rl82uck5ej3nvlh6vp3k5"
    ]
    addrs.forEach((address: string): void => {
      bintools.stringToAddress(address)
    })
    ...
    addrs = [
      "C-addismya1dcfyuug87xqayl4fpp02z9dvknwhafds7d29h6",
      "C-addismya1ltghj033re64920k786uprcp82p9e36jtkmpm3",
      "C-addismya1dq4q9seql2spxrkd7rl82uck5ej3nvlhk79w6t"
    ]
    addrs.forEach((address: string): void => {
      bintools.stringToAddress(address)
    })
    ...
    addrs = [
      "C-cflt1dcfyuug87xqayl4fpp02z9dvknwhafdsjlw6m9",
      "C-cflt1ltghj033re64920k786uprcp82p9e36j8yl7hw",
      "C-cflt1dq4q9seql2spxrkd7rl82uck5ej3nvlh6vp3k5"
    ]
    addrs.forEach((address: string): void => {
      bintools.stringToAddress(address)
    })
