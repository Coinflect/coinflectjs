...
describe("Keystore", (): void => {
  const username1: string = "coinflectJsUser1"
  const username2: string = "coinflectJsUser2"
  const username3: string = "coinflectJsUser3"
  const password: string = "coinflectJsP1ssw4rd"
